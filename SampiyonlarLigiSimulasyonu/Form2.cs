...
namespace SampiyonlarLigiSimulasyonu
{
    public partial class Form2 : Form
    {
        ...
        private Form1 anaform = null;

        public Form2(Form form)
        {
            InitializeComponent();
            anaform = form as Form1;
        }
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            List<string> takimlar = A.Aclass.ToList();
        ...
        private void MacSonucuPuanla(Label lbltakim1, Label lbltakim2, Label lbltakim3, Label lbltakim4, Label lblpuan1, Label lblpuan2, Label lblpuan3, Label lblpuan4)
        {
            ...
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan1 += 3;
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(lbl1haftasonuc1.Text) > Convert.ToInt32(lbl1haftasonuc2.Text))
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan1 += 3;
            ...
            if (Convert.ToInt32(lbl1haftasonuc3.Text) > Convert.ToInt32(lbl1haftasonuc4.Text))
            {
                puan3 += 3;
            ...
            labelpuan1.Text = puan1.ToString();
            labelpuan2.Text = puan2.ToString();
            labelpuan3.Text = puan3.ToString();
            labelpuan4.Text = puan4.ToString();
        ...
        private void btn2haftaSonuc_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(lbl2haftasonuc1.Text) > Convert.ToInt32(lbl2haftasonuc2.Text))
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan1 += 3;
            ...
            if (Convert.ToInt32(lbl2haftasonuc3.Text) > Convert.ToInt32(lbl2haftasonuc4.Text))
            {
                puan2 += 3;
        ...
        private void btn3haftaSonuc_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(lbl3haftasonuc1.Text) > Convert.ToInt32(lbl3haftasonuc2.Text))
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan1 += 3;
            ...
            if (Convert.ToInt32(lbl3haftasonuc3.Text) > Convert.ToInt32(lbl3haftasonuc4.Text))
            {
                puan2 += 3;
        ...
        private void btn4haftaSonuc_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(lbl4haftasonuc1.Text) > Convert.ToInt32(lbl4haftasonuc2.Text))
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan2 += 3;
            ...
            if (Convert.ToInt32(lbl4haftasonuc3.Text) > Convert.ToInt32(lbl4haftasonuc4.Text))
            {
                puan4 += 3;
        ...
        private void btn5haftaSonuc_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(lbl5haftasonuc1.Text) > Convert.ToInt32(lbl5haftasonuc2.Text))
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan3 += 3;
            ...
            if (Convert.ToInt32(lbl5haftasonuc3.Text) > Convert.ToInt32(lbl5haftasonuc4.Text))
            {
                puan4 += 3;
        ...
        private void btn6haftaSonuc_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(lbl6haftasonuc1.Text) > Convert.ToInt32(lbl6haftasonuc2.Text))
            {//lok moskova 1. hafta 2. sırada puan yeri 2 . 2. hafta 3. sırada puan yeri hala 2
                puan4 += 3;
            ...
            if (Convert.ToInt32(lbl6haftasonuc3.Text) > Convert.ToInt32(lbl6haftasonuc4.Text))
            {
                puan3 += 3;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //label2.Text = sonPuanDurumu[1].ToString();


            //puanListesi.OrderByDescending(x=>x)

            //if (puan1 > puan2 && puan1 > puan3 && puan1 > puan4)
            //{
            //	label1.Text = lbltakimadi1.Text;
            //}
            //if (puan2 > puan1 && puan2 > puan3 && puan2 > puan4)
            //{
            //	label1.Text = lbltakimadi2.Text;
            //}
            //if (puan3 > puan1 && puan3 > puan2 && puan3 > puan4)
            //{
            //	label1.Text = lbltakimadi3.Text;
            //}
            //if (puan4 > puan1 && puan4 > puan2 && puan4 > puan3)
            //{
            //	label1.Text = lbltakimadi1.Text;
            //}
            ...
            //{
            //	if (mak < puanListesi[i])
            //	{
            //		mak = puanListesi[i];
            //	}
            //}
            //MessageBox.Show(mak.ToString());



            //if (Convert.ToInt32(labelpuan1.Text) > Convert.ToInt32(labelpuan2.Text) && Convert.ToInt32(labelpuan1.Text) > Convert.ToInt32(labelpuan3.Text) && Convert.ToInt32(labelpuan1.Text) > Convert.ToInt32(labelpuan4.Text))
            //{
            //	label1.Text = lbltakimadi1.Text;
            //}
            //else if (Convert.ToInt32(labelpuan2.Text) > Convert.ToInt32(labelpuan1.Text) && Convert.ToInt32(labelpuan2.Text) > Convert.ToInt32(labelpuan3.Text) && Convert.ToInt32(labelpuan2.Text) > Convert.ToInt32(labelpuan4.Text))
            //{
            //	label1.Text = lbltakimadi2.Text;
            //}
            //else if (Convert.ToInt32(labelpuan3.Text) > Convert.ToInt32(labelpuan1.Text) && Convert.ToInt32(labelpuan3.Text) > Convert.ToInt32(labelpuan2.Text) && Convert.ToInt32(labelpuan3.Text) > Convert.ToInt32(labelpuan4.Text))
            //{
            //	label1.Text = lbltakimadi3.Text;
            //}
            //else if (Convert.ToInt32(labelpuan4.Text) > Convert.ToInt32(labelpuan1.Text) && Convert.ToInt32(labelpuan4.Text) > Convert.ToInt32(labelpuan2.Text) && Convert.ToInt32(labelpuan4.Text) > Convert.ToInt32(labelpuan3.Text))
            //{
            //	label1.Text = lbltakimadi4.Text;
            //}
